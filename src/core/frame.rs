...
impl Frame {
    ...
    pub fn new() -> Self { Self { map: HashMap::new(), meta: HashMap::new() } }

    /// Creates an empty Frame with the specified capacity.
    pub fn with_capacity(cap: usize) -> Self { Self { map: HashMap::with_capacity(cap), meta: HashMap::new() } }
    ...
    // Metadata is exposed directly via `frame.meta` (HashMap<String, String>).
