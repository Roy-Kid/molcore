use molomni::core::forcefield::{ForceField, Symbol, Alias, Charge, Mass};
...
fn create_bond_type_between_atoms() {
    use molomni::core::forcefield::BondType;
...
fn bond_properties_generic() {
    use molomni::core::forcefield::{SpringConstant, EquilibriumLength};
